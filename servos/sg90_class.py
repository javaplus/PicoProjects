...
class SG90:
    ...
    def __init__(self, pin, debug=False) -> None:
    ...
    def _calc_pulse_width(self,angle):
    ...
    def duty_cycle_for_angle(self,angle):
        ...
        pulse_width=self._calc_pulse_width(angle)
        #duty=int(interval_mapping(pulse_width, 0, 20, 0,65535))
        duty=int(self._calc_duty_cycle(pulse_width))
        if self.DEBUG:
